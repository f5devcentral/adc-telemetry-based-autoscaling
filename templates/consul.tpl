...
#Download Consul
curl --silent --remote-name https://releases.hashicorp.com/consul/${consul_ver}/consul_${consul_ver}_linux_amd64.zip
...
#Create Consul CA and server certificates
consul tls ca create && consul tls cert create -server && sudo mv dc1-server-consul-0.pem dc1-server-consul-0-key.pem consul-agent-ca.pem /home/ubuntu/
